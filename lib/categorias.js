...
export const CATEGORIAS = {
  ...
  religiosas: {
    ...
    configurador: true,
    // Galería del configurador (hasta 6 fotos reales de cirios/velones). No
    // depende del diámetro; las medidas se eligen con los selectores. Cada foto
    // lleva su color: el conjunto (tono cera) = Marfil; los pilares individuales
    // (tono crema claro) = Blanco nieve. Cambiar el `color` aquí si hace falta.
    configuradorFotos: [
