...
export const CATEGORIAS = {
  ...
  religiosas: {
    ...
    configurador: true,
    // Galería COMPARTIDA del configurador (hasta 6). Muestra el acabado y color
    // reales, iguales en todas las medidas (el tamaño lo comunica la silueta a
    // escala). Empezamos con 4; agregar aquí las 2 restantes cuando estén.
    configuradorFotos: [
      '/images/productos/religiosa-3-8x5-blanca/01.jpg',
      '/images/productos/religiosa-4-9x15-blanca/01.jpg',
      '/images/productos/religiosa-7x15-blanca/01.jpg',
      '/images/productos/religiosa-7-5x5-blanca/01.jpg',
    ],
    descripcion:
