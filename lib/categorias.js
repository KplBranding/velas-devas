...
export const CATEGORIAS = {
  ...
  funerarias: {
    ...
    landing: {
      ...
      beneficios: [
        {
          t: 'Combustión uniforme: la vela quema de forma pareja, aprovechando toda su duración.',
        },
        {
          t: 'Menor derrame de cera: procesos de fabricación controlados que reducen el exceso de cera líquida.',
        },
        {
          t: 'Llama estable: pabilos de calidad que favorecen una llama limpia y constante.',
        },
        {
          t: 'Mayor duración: velas diseñadas para un rendimiento confiable durante toda la ceremonia.',
        },
        {
          t: 'Calidad consistente: cada lote mantiene los mismos estándares para entregar siempre el mismo resultado.',
        },
      ],
      pausa: {
        frase: 'En una ceremonia de despedida no hay espacio para improvisar.',
        imagen:
          '/images/fotos_web/candles-are-lit-table-with-flowers-candles-generative-ai.jpg', // 🖼️ placeholder
        pos: '50% 50%',
        cta: 'Haz tu pedido aquí',
      },
      oficio: {
        ...
        texto:
          'Porque en un momento de despedida cada detalle importa. Desde hace más de 30 años fabricamos velas con combustión uniforme, buena duración y calidad constante, cumpliendo lo prometido en cada pedido, para que puedas concentrarte en lo realmente importante: acompañar.',
      ...
      fotoFranja:
        '/images/fotos_web/candles-are-lit-table-with-vase-flowers-couple-background-generative-ai.jpg', // 🖼️ placeholder
      ctaFinal: {
        ...
        boton: 'Contáctanos',
        imagen: '/images/editorial/vela-oscura.jpg', // 🖼️ placeholder (tono sobrio)
      },
    },
  },
};
